...
import polinema.ac.id.recyclerviewsangatsederhana.adaptersnicola.SuperHeroAdapter;
import polinema.ac.id.recyclerviewsangatsederhana.modelsnicola.SuperHero;
